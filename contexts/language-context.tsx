...
const translations = {
  en: {
    ...
    // Training section
    "training.hero.title": "Medical Training & Education",
    "training.hero.subtitle": "Empowering the next generation of pharmaceutical professionals through comprehensive training programs.",
    "training.overview.title": "Program Overview",
    "training.overview.description": "Our training program is designed to provide trainees with deep industry knowledge, practical skills, and professional development opportunities.",
    "training.forWho.title": "Who It's For",
    "training.forWho.description": "Aspiring pharmaceutical representatives, medical students, and recent graduates looking to build a career in the pharmaceutical industry.",
    "training.curriculum.title": "Curriculum",
    "training.curriculum.module1": "Pharmaceutical Sales Basics",
    "training.curriculum.module2": "Product Knowledge",
    "training.curriculum.module3": "Compliance & Ethics",
    "training.curriculum.module4": "Communication Skills",
    "training.cta.title": "Ready to Start Your Career?",
    "training.cta.button": "Apply Now",

    // Training enhanced sections
    "training.stats.trainees": "Trained Professionals",
    "training.stats.rate": "Success Rate",
    "training.stats.partners": "Partner Companies",
    "training.stats.years": "Years Experience",
    "training.benefits.title": "Why Choose Our Program",
    "training.benefits.mentorship": "Expert Mentorship",
    "training.benefits.mentorshipDesc": "Learn from industry veterans with decades of experience",
    "training.benefits.practical": "Hands-On Training",
    "training.benefits.practicalDesc": "Real-world scenarios and practical exercises",
    "training.benefits.certification": "Certification",
    "training.benefits.certificationDesc": "Receive recognized industry certification",
    "training.benefits.placement": "Career Placement",
    "training.benefits.placementDesc": "Direct employment opportunities with our partners",
    "training.process.title": "Training Journey",
    "training.process.step1.title": "Application",
    "training.process.step1.desc": "Submit your application and documents",
    "training.process.step2.title": "Selection",
    "training.process.step2.desc": "Interview and assessment process",
    "training.process.step3.title": "Training",
    "training.process.step3.desc": "Intensive 3-month program",
    "training.process.step4.title": "Placement",
    "training.process.step4.desc": "Join our team or partners",

    // Regulatory Services Page
    "nav.regulatory": "Regulatory Services",
    "regulatory.hero.badge": "Pharmaceutical Registration",
    "regulatory.hero.title": "Drug Registration & Regulatory Affairs",
    "regulatory.hero.subtitle": "Your trusted partner for pharmaceutical product registration in Uzbekistan. We help international companies navigate the regulatory landscape and bring their medicines to market.",
    "regulatory.hero.cta": "Get Consultation",

    "regulatory.about.title": "About Our Services",
    "regulatory.about.description": "NEUES LEBEN provides comprehensive regulatory affairs services for pharmaceutical companies looking to register their products in Uzbekistan. With years of experience and deep understanding of local regulations, we ensure smooth and successful market access for your medicines.",

    "regulatory.mission.title": "Our Mission",
    "regulatory.mission.description": "To deliver fast, transparent, and reliable regulatory solutions, ensuring smooth and successful market access for manufacturers in Uzbekistan.",

    "regulatory.categories.pharma": "Pharmaceuticals",
    "regulatory.categories.devices": "Medical Devices",
    "regulatory.categories.supplements": "Food Supplements",

    "regulatory.services.title": "Our Core Services",
    "regulatory.services.subtitle": "Comprehensive regulatory support for your pharmaceutical products",

    "regulatory.service1.title": "Registration of Medicinal Products",
    "regulatory.service1.item1": "Full-cycle state registration of new medicinal products",
    "regulatory.service1.item2": "Renewal and re-registration",
    "regulatory.service1.item3": "Submission of variations to Registration Certificates",
    "regulatory.service1.item4": "Preparation of submission packages for the Ministry of Health",
    "regulatory.service1.item5": "Full management of communication with regulatory authorities",

    "regulatory.service2.title": "Registration of Medical Devices and Equipment",
    "regulatory.service2.item1": "Registration of medical devices and medical equipment",
    "regulatory.service2.item2": "Fast-track registration through recognition",
    "regulatory.service2.item3": "Product classification and regulatory pathway assessment",
    "regulatory.service2.item4": "Preparation of technical documentation and labeling",
    "regulatory.service2.item5": "Post-registration amendments and updates",

    "regulatory.service3.title": "Registration of Food Supplements, Cosmetics & Sports Nutrition",
    "regulatory.service3.item1": "Registration and notification procedures",
    "regulatory.service3.item2": "Compliance review of composition and labeling",
    "regulatory.service3.item3": "Preparation of safety and quality documentation",
    "regulatory.service3.item4": "High-volume portfolio processing with short timelines",

    "regulatory.service4.title": "Clinical Trials Support",
    "regulatory.service4.description": "NEUES LEBEN assists manufacturers in organizing and managing clinical research activities in Uzbekistan:",
    "regulatory.service4.item1": "Preparation of clinical trial submission packages",
    "regulatory.service4.item2": "Coordination with the Ministry of Health and Ethics Committees",
    "regulatory.service4.item3": "Assistance in protocol localization and adaptation",
    "regulatory.service4.item4": "Support for site selection and communication",
    "regulatory.service4.item5": "Guidance throughout the authorization process for clinical studies",

    "regulatory.service5.title": "Pre-Inspection & GMP Inspection Support",
    "regulatory.service5.description": "We help manufacturers prepare for and successfully pass national GMP inspections:",
    "regulatory.service5.item1": "Pre-inspection audit based on Uzbekistan's GMP requirements",
    "regulatory.service5.item2": "Gap analysis of manufacturing processes and documentation",
    "regulatory.service5.item3": "Preparation of corrective action plans",
    "regulatory.service5.item4": "Support during on-site or remote GMP inspections",
    "regulatory.service5.item5": "Communication with national authorities and follow-up documentation",

    "regulatory.process.title": "How We Work",
    "regulatory.process.step1.title": "Initial Consultation",
    "regulatory.process.step1.desc": "We analyze your product and determine the optimal registration pathway",
    "regulatory.process.step2.title": "Documentation",
    "regulatory.process.step2.desc": "We prepare and review all required regulatory documentation",
    "regulatory.process.step3.title": "Submission",
    "regulatory.process.step3.desc": "We submit your application to regulatory authorities",
    "regulatory.process.step4.title": "Follow-up",
    "regulatory.process.step4.desc": "We manage all communications until approval is obtained",

    "regulatory.contact.title": "Request a Consultation",
    "regulatory.contact.subtitle": "Ready to register your products in Uzbekistan? Get in touch with our regulatory team.",
    "regulatory.contact.form.company": "Company Name",
    "regulatory.contact.form.companyPlaceholder": "Your company name",
    "regulatory.contact.form.country": "Country",
    "regulatory.contact.form.countryPlaceholder": "Your country",
    "regulatory.contact.form.productType": "Product Type",
    "regulatory.contact.form.productTypePlaceholder": "e.g., Pharmaceutical, Medical Device, Supplement",
    "regulatory.contact.form.submit": "Submit Inquiry",

    "regulatory.stats.registrations": "Successful Registrations",
    "regulatory.stats.countries": "Partner Countries",
    "regulatory.stats.experience": "Years Experience",
    "regulatory.stats.clients": "Satisfied Clients",

    // News
    "nav.news": "News",
    "news.badge": "Company News",
    "news.title": "Company News & Updates",
    "news.subtitle": "Stay informed about our latest events, partnerships, achievements, and company developments.",
    "news.loading": "Loading news...",
    "news.tryAgain": "Try Again",
    "news.searchPlaceholder": "Search news by title...",
    "news.showingArticles": "Showing {count} articles",
    "news.allCategories": "All Categories",
    "news.noResults": "No news found matching your criteria.",
  ...
  uz: {
    ...
    // Training section
    "training.hero.title": "Tibbiy Ta'lim va Trening",
    "training.hero.subtitle": "Keng qamrovli o'quv dasturlari orqali kelajakdagi farmatsevtika mutaxassislarini tayyorlash.",
    "training.overview.title": "Dastur haqida",
    "training.overview.description": "Bizning o'quv dasturimiz stajyorlarga chuqur soha bilimlarini, amaliy ko'nikmalarni va kasbiy rivojlanish imkoniyatlarini berish uchun ishlab chiqilgan.",
    "training.forWho.title": "Kimlar uchun",
    "training.forWho.description": "Farmatsevtika sohasida karyera qurishni istagan bo'lajak tibbiy vakillar, tibbiyot talabalari va yangi bitiruvchilar uchun.",
    "training.curriculum.title": "O'quv Dasturi",
    "training.curriculum.module1": "Farmatsevtika savdosi asoslari",
    "training.curriculum.module2": "Mahsulot bilimlari",
    "training.curriculum.module3": "Muvofiqlik va Etika",
    "training.curriculum.module4": "Muloqot ko'nikmalari",
    "training.cta.title": "Karyerangizni boshlashga tayyormisiz?",
    "training.cta.button": "Ariza topshirish",

    // Training enhanced sections
    "training.stats.trainees": "O'qitilgan Mutaxassislar",
    "training.stats.rate": "Muvaffaqiyat Darajasi",
    "training.stats.partners": "Hamkor Kompaniyalar",
    "training.stats.years": "Yillik Tajriba",
    "training.benefits.title": "Nima Uchun Bizning Dasturimiz",
    "training.benefits.mentorship": "Ekspert Ustozlik",
    "training.benefits.mentorshipDesc": "O'n yillik tajribaga ega soha veteranlaridan o'rganing",
    "training.benefits.practical": "Amaliy Mashg'ulotlar",
    "training.benefits.practicalDesc": "Haqiqiy stsenariylar va amaliy mashqlar",
    "training.benefits.certification": "Sertifikatlash",
    "training.benefits.certificationDesc": "Tan olingan soha sertifikatini oling",
    "training.benefits.placement": "Ishga Joylashtirish",
    "training.benefits.placementDesc": "Hamkorlarimiz bilan to'g'ridan-to'g'ri ish imkoniyatlari",
    "training.process.title": "O'quv Yo'li",
    "training.process.step1.title": "Ariza",
    "training.process.step1.desc": "Ariza va hujjatlarni topshiring",
    "training.process.step2.title": "Tanlov",
    "training.process.step2.desc": "Suhbat va baholash jarayoni",
    "training.process.step3.title": "O'qitish",
    "training.process.step3.desc": "Intensiv 3 oylik dastur",
    "training.process.step4.title": "Joylashtirish",
    "training.process.step4.desc": "Jamoamizga yoki hamkorlarga qo'shiling",

    // Regulatory Services Page
    "nav.regulatory": "Regulyativ Xizmatlar",
    "regulatory.hero.badge": "Farmatsevtika Ro'yxatga Olish",
    "regulatory.hero.title": "Dori Vositalarini Ro'yxatga Olish va Regulyativ Ishlar",
    "regulatory.hero.subtitle": "O'zbekistonda farmatsevtika mahsulotlarini ro'yxatga olish bo'yicha ishonchli hamkoringiz. Biz xalqaro kompaniyalarga regulyativ muhitda yo'l ko'rsatamiz va ularning dorilarini bozorga chiqarishga yordam beramiz.",
    "regulatory.hero.cta": "Konsultatsiya Olish",

    "regulatory.about.title": "Xizmatlarimiz Haqida",
    "regulatory.about.description": "NEUES LEBEN O'zbekistonda mahsulotlarini ro'yxatga olishni xohlaydigan farmatsevtika kompaniyalari uchun keng qamrovli regulyativ xizmatlarni taqdim etadi. Ko'p yillik tajriba va mahalliy qoidalarni chuqur tushunish orqali biz dorilaringiz uchun bozorga muammosiz kirish imkonini ta'minlaymiz.",

    "regulatory.mission.title": "Bizning Missiyamiz",
    "regulatory.mission.description": "O'zbekistonda ishlab chiqaruvchilar uchun bozorga muammosiz va muvaffaqiyatli kirish imkonini ta'minlab, tez, shaffof va ishonchli regulyativ yechimlarni taqdim etish.",

    "regulatory.categories.pharma": "Farmatsevtika",
    "regulatory.categories.devices": "Tibbiy Asboblar",
    "regulatory.categories.supplements": "Oziq-ovqat Qo'shimchalari",

    "regulatory.services.title": "Asosiy Xizmatlarimiz",
    "regulatory.services.subtitle": "Farmatsevtika mahsulotlaringiz uchun keng qamrovli regulyativ qo'llab-quvvatlash",

    "regulatory.service1.title": "Dori Vositalarini Ro'yxatga Olish",
    "regulatory.service1.item1": "Yangi dori vositalarini davlat ro'yxatga olishning to'liq sikli",
    "regulatory.service1.item2": "Yangilash va qayta ro'yxatga olish",
    "regulatory.service1.item3": "Ro'yxatga olish Sertifikatlariga o'zgarishlar kiritish",
    "regulatory.service1.item4": "Sog'liqni saqlash Vazirligi uchun taqdim etish paketlarini tayyorlash",
    "regulatory.service1.item5": "Regulyativ organlar bilan aloqalarni to'liq boshqarish",

    "regulatory.service2.title": "Tibbiy Qurilmalar va Jihozlarni Ro'yxatga Olish",
    "regulatory.service2.item1": "Tibbiy qurilmalar va tibbiy jihozlarni ro'yxatga olish",
    "regulatory.service2.item2": "Tan olish orqali tezkor ro'yxatga olish",
    "regulatory.service2.item3": "Mahsulot klassifikatsiyasi va regulyativ yo'l baholash",
    "regulatory.service2.item4": "Texnik hujjatlar va yorliqlarni tayyorlash",
    "regulatory.service2.item5": "Ro'yxatga olishdan keyingi o'zgartirishlar va yangilanishlar",

    "regulatory.service3.title": "Oziq-ovqat Qo'shimchalari, Kosmetika va Sport Ovqatlanishini Ro'yxatga Olish",
    "regulatory.service3.item1": "Ro'yxatga olish va xabardor qilish tartib-qoidalari",
    "regulatory.service3.item2": "Tarkib va yorliqlarning muvofiqligini tekshirish",
    "regulatory.service3.item3": "Xavfsizlik va sifat hujjatlarini tayyorlash",
    "regulatory.service3.item4": "Qisqa muddatlarda yuqori hajmli portfelni qayta ishlash",

    "regulatory.service4.title": "Klinik Sinovlarni Qo'llab-quvvatlash",
    "regulatory.service4.description": "NEUES LEBEN ishlab chiqaruvchilarga O'zbekistonda klinik tadqiqot faoliyatini tashkil etish va boshqarishda yordam beradi:",
    "regulatory.service4.item1": "Klinik sinov taqdim etish paketlarini tayyorlash",
    "regulatory.service4.item2": "Sog'liqni saqlash Vazirligi va Etika qo'mitalari bilan muvofiqlashtirish",
    "regulatory.service4.item3": "Protokolni lokalizatsiya qilish va moslashtirishda yordam",
    "regulatory.service4.item4": "Sayt tanlash va aloqa bo'yicha qo'llab-quvvatlash",
    "regulatory.service4.item5": "Klinik tadqiqotlar uchun ruxsat berish jarayoni davomida yo'l-yo'riq",

    "regulatory.service5.title": "Oldindan Tekshiruv va GMP Tekshiruvini Qo'llab-quvvatlash",
    "regulatory.service5.description": "Biz ishlab chiqaruvchilarga milliy GMP tekshiruvlariga tayyorlanish va muvaffaqiyatli o'tishda yordam beramiz:",
    "regulatory.service5.item1": "O'zbekiston GMP talablariga asoslangan oldindan tekshiruv auditi",
    "regulatory.service5.item2": "Ishlab chiqarish jarayonlari va hujjatlarning kamchiliklarini tahlil qilish",
    "regulatory.service5.item3": "Tuzatish chora-tadbirlari rejalarini tayyorlash",
    "regulatory.service5.item4": "Joylarda yoki masofadan GMP tekshiruvlari paytida qo'llab-quvvatlash",
    "regulatory.service5.item5": "Milliy organlar bilan aloqa va keyingi hujjatlar",

    "regulatory.process.title": "Biz Qanday Ishlaymiz",
    "regulatory.process.step1.title": "Dastlabki Konsultatsiya",
    "regulatory.process.step1.desc": "Biz mahsulotingizni tahlil qilamiz va optimal ro'yxatga olish yo'lini aniqlaymiz",
    "regulatory.process.step2.title": "Hujjatlashtirish",
    "regulatory.process.step2.desc": "Biz barcha zarur regulyativ hujjatlarni tayyorlaymiz va ko'rib chiqamiz",
    "regulatory.process.step3.title": "Taqdim Etish",
    "regulatory.process.step3.desc": "Biz arizangizni regulyativ organlarga topshiramiz",
    "regulatory.process.step4.title": "Kuzatuv",
    "regulatory.process.step4.desc": "Biz tasdiqlash olinguncha barcha aloqalarni boshqaramiz",

    "regulatory.contact.title": "Konsultatsiya So'rash",
    "regulatory.contact.subtitle": "O'zbekistonda mahsulotlaringizni ro'yxatga olishga tayyormisiz? Regulyativ jamoamiz bilan bog'laning.",
    "regulatory.contact.form.company": "Kompaniya Nomi",
    "regulatory.contact.form.companyPlaceholder": "Kompaniyangiz nomi",
    "regulatory.contact.form.country": "Mamlakat",
    "regulatory.contact.form.countryPlaceholder": "Mamlakatangiz",
    "regulatory.contact.form.productType": "Mahsulot Turi",
    "regulatory.contact.form.productTypePlaceholder": "masalan, Farmatsevtika, Tibbiy Qurilma, Qo'shimcha",
    "regulatory.contact.form.submit": "So'rov Yuborish",

    "regulatory.stats.registrations": "Muvaffaqiyatli Ro'yxatga Olishlar",
    "regulatory.stats.countries": "Hamkor Mamlakatlar",
    "regulatory.stats.experience": "Yillik Tajriba",
    "regulatory.stats.clients": "Mamnun Mijozlar",

    // News
    "nav.news": "Yangiliklar",
    "news.badge": "Kompaniya Yangiliklari",
    "news.title": "Kompaniya Yangiliklari va Yangilanishlar",
    "news.subtitle": "Eng so'nggi tadbirlar, hamkorliklar, yutuqlar va kompaniya yangilanishlari haqida xabardor bo'ling.",
    "news.loading": "Yangiliklar yuklanmoqda...",
    "news.tryAgain": "Qayta urinish",
    "news.searchPlaceholder": "Yangiliklar sarlavhasi bo'yicha qidirish...",
    "news.showingArticles": "{count} ta maqola ko'rsatilmoqda",
    "news.allCategories": "Barcha kategoriyalar",
    "news.noResults": "Mezonlarga mos yangiliklar topilmadi.",
    "news.readMore": "Batafsil",
    "news.previous": "Oldingi",
    "news.next": "Keyingi",
    "news.page": "Sahifa",
    "news.of": "dan",
  ...
  ru: {
    ...
    // Training section
    "training.hero.title": "Медицинское Обучение и Образование",
    "training.hero.subtitle": "Подготовка следующего поколения специалистов фармацевтической отрасли через комплексные программы обучения.",
    "training.overview.title": "Обзор Программы",
    "training.overview.description": "Наша программа обучения разработана для предоставления стажёрам глубоких отраслевых знаний, практических навыков и возможностей профессионального развития.",
    "training.forWho.title": "Для Кого Программа",
    "training.forWho.description": "Для начинающих фармацевтических представителей, студентов-медиков и выпускников, стремящихся построить карьеру в фармацевтической отрасли.",
    "training.curriculum.title": "Учебная Программа",
    "training.curriculum.module1": "Основы Фармацевтических Продаж",
    "training.curriculum.module2": "Знание Продуктов",
    "training.curriculum.module3": "Комплаенс и Этика",
    "training.curriculum.module4": "Навыки Коммуникации",
    "training.cta.title": "Готовы Начать Карьеру?",
    "training.cta.button": "Подать Заявку",

    // Training enhanced sections
    "training.stats.trainees": "Обученных Специалистов",
    "training.stats.rate": "Процент Успеха",
    "training.stats.partners": "Компаний-Партнёров",
    "training.stats.years": "Лет Опыта",
    "training.benefits.title": "Почему Выбирают Нашу Программу",
    "training.benefits.mentorship": "Экспертное Наставничество",
    "training.benefits.mentorshipDesc": "Обучайтесь у ветеранов отрасли с многолетним опытом",
    "training.benefits.practical": "Практическое Обучение",
    "training.benefits.practicalDesc": "Реальные сценарии и практические упражнения",
    "training.benefits.certification": "Сертификация",
    "training.benefits.certificationDesc": "Получите признанный отраслевой сертификат",
    "training.benefits.placement": "Трудоустройство",
    "training.benefits.placementDesc": "Прямые возможности трудоустройства у наших партнёров",
    "training.process.title": "Путь Обучения",
    "training.process.step1.title": "Подача Заявки",
    "training.process.step1.desc": "Отправьте заявку и документы",
    "training.process.step2.title": "Отбор",
    "training.process.step2.desc": "Собеседование и оценка",
    "training.process.step3.title": "Обучение",
    "training.process.step3.desc": "Интенсивная 3-месячная программа",
    "training.process.step4.title": "Трудоустройство",
    "training.process.step4.desc": "Присоединяйтесь к нашей команде или партнёрам",

    // Regulatory Services Page
    "nav.regulatory": "Регуляторные Услуги",
    "regulatory.hero.badge": "Фармацевтическая Регистрация",
    "regulatory.hero.title": "Регистрация Лекарственных Средств и Регуляторная Деятельность",
    "regulatory.hero.subtitle": "Ваш надёжный партнёр по регистрации фармацевтической продукции в Узбекистане. Мы помогаем международным компаниям ориентироваться в регуляторной среде и выводить лекарства на рынок.",
    "regulatory.hero.cta": "Получить Консультацию",

    "regulatory.about.title": "О Наших Услугах",
    "regulatory.about.description": "NEUES LEBEN предоставляет комплексные регуляторные услуги для фармацевтических компаний, желающих зарегистрировать свою продукцию в Узбекистане. Благодаря многолетнему опыту и глубокому пониманию местного законодательства мы обеспечиваем успешный доступ ваших лекарств на рынок.",

    "regulatory.mission.title": "Наша Миссия",
    "regulatory.mission.description": "Предоставлять быстрые, прозрачные и надёжные регуляторные решения, обеспечивая плавный и успешный выход производителей на рынок Узбекистана.",

    "regulatory.categories.pharma": "Фармацевтика",
    "regulatory.categories.devices": "Медицинские Изделия",
    "regulatory.categories.supplements": "БАДы",

    "regulatory.services.title": "Наши Основные Услуги",
    "regulatory.services.subtitle": "Комплексная регуляторная поддержка вашей фармацевтической продукции",

    "regulatory.service1.title": "Регистрация Лекарственных Средств",
    "regulatory.service1.item1": "Полный цикл государственной регистрации новых лекарственных средств",
    "regulatory.service1.item2": "Продление и перерегистрация",
    "regulatory.service1.item3": "Подача вариаций к Регистрационным Удостоверениям",
    "regulatory.service1.item4": "Подготовка регистрационных досье для Министерства Здравоохранения",
    "regulatory.service1.item5": "Полное сопровождение коммуникаций с регуляторными органами",

    "regulatory.service2.title": "Регистрация Медицинских Изделий и Оборудования",
    "regulatory.service2.item1": "Регистрация медицинских изделий и медицинского оборудования",
    "regulatory.service2.item2": "Ускоренная регистрация через признание",
    "regulatory.service2.item3": "Классификация продукции и оценка регуляторного пути",
    "regulatory.service2.item4": "Подготовка технической документации и маркировки",
    "regulatory.service2.item5": "Пострегистрационные изменения и обновления",

    "regulatory.service3.title": "Регистрация БАДов, Косметики и Спортивного Питания",
    "regulatory.service3.item1": "Процедуры регистрации и уведомления",
    "regulatory.service3.item2": "Проверка соответствия состава и маркировки",
    "regulatory.service3.item3": "Подготовка документации по безопасности и качеству",
    "regulatory.service3.item4": "Обработка большого портфеля продуктов в короткие сроки",

    "regulatory.service4.title": "Поддержка Клинических Исследований",
    "regulatory.service4.description": "NEUES LEBEN помогает производителям в организации и проведении клинических исследований в Узбекистане:",
    "regulatory.service4.item1": "Подготовка пакетов документов для клинических исследований",
    "regulatory.service4.item2": "Координация с Министерством здравоохранения и Этическими комитетами",
    "regulatory.service4.item3": "Помощь в локализации и адаптации протоколов",
    "regulatory.service4.item4": "Поддержка в выборе исследовательских центров и коммуникации",
    "regulatory.service4.item5": "Сопровождение на всех этапах получения разрешения на клинические исследования",

    "regulatory.service5.title": "Подготовка к Инспекциям и Поддержка GMP Инспекций",
    "regulatory.service5.description": "Мы помогаем производителям подготовиться и успешно пройти национальные GMP инспекции:",
    "regulatory.service5.item1": "Прединспекционный аудит на соответствие требованиям GMP Узбекистана",
    "regulatory.service5.item2": "Анализ пробелов в производственных процессах и документации",
    "regulatory.service5.item3": "Подготовка планов корректирующих мероприятий",
    "regulatory.service5.item4": "Поддержка во время выездных или дистанционных GMP инспекций",
    "regulatory.service5.item5": "Коммуникация с государственными органами и последующая документация",

    "regulatory.process.title": "Как Мы Работаем",
    "regulatory.process.step1.title": "Первичная Консультация",
    "regulatory.process.step1.desc": "Мы анализируем ваш продукт и определяем оптимальный путь регистрации",
    "regulatory.process.step2.title": "Документация",
    "regulatory.process.step2.desc": "Мы подготавливаем и проверяем всю необходимую регуляторную документацию",
    "regulatory.process.step3.title": "Подача",
    "regulatory.process.step3.desc": "Мы подаём вашу заявку в регуляторные органы",
    "regulatory.process.step4.title": "Сопровождение",
    "regulatory.process.step4.desc": "Мы ведём все коммуникации до получения одобрения",

    "regulatory.contact.title": "Запросить Консультацию",
    "regulatory.contact.subtitle": "Готовы зарегистрировать свою продукцию в Узбекистане? Свяжитесь с нашей регуляторной командой.",
    "regulatory.contact.form.company": "Название Компании",
    "regulatory.contact.form.companyPlaceholder": "Название вашей компании",
    "regulatory.contact.form.country": "Страна",
    "regulatory.contact.form.countryPlaceholder": "Ваша страна",
    "regulatory.contact.form.productType": "Тип Продукта",
    "regulatory.contact.form.productTypePlaceholder": "напр., Фармацевтика, Медизделие, БАД",
    "regulatory.contact.form.submit": "Отправить Запрос",

    "regulatory.stats.registrations": "Успешных Регистраций",
    "regulatory.stats.countries": "Стран-Партнёров",
    "regulatory.stats.experience": "Лет Опыта",
    "regulatory.stats.clients": "Довольных Клиентов",

    // News
    "nav.news": "Новости",
    "news.badge": "Новости Компании",
    "news.title": "Новости и Обновления Компании",
    "news.subtitle": "Будьте в курсе наших последних событий, партнёрств, достижений и корпоративных обновлений.",
    "news.loading": "Загрузка новостей...",
    "news.tryAgain": "Попробовать снова",
    "news.searchPlaceholder": "Поиск новостей по заголовку...",
    "news.showingArticles": "Показано {count} статей",
    "news.allCategories": "Все категории",
    "news.noResults": "Новости по вашим критериям не найдены.",
  ...
  de: {
    ...
    "training.hero.title": "Medizinische Ausbildung",
    "training.hero.subtitle": "Befähigung der nächsten Generation von Pharmafachleuten durch umfassende Schulungsprogramme.",
    "training.overview.title": "Programmübersicht",
    "training.overview.description": "Unser Schulungsprogramm vermittelt Auszubildenden tiefes Branchenwissen, praktische Fähigkeiten und berufliche Entwicklungsmöglichkeiten.",
    "training.forWho.title": "Für Wen",
    "training.forWho.description": "Angehende Pharmareferenten, Medizinstudenten und Absolventen, die eine Karriere in der Pharmaindustrie anstreben.",
    "training.curriculum.title": "Lehrplan",
    "training.curriculum.module1": "Grundlagen des Pharmavertriebs",
    "training.curriculum.module2": "Produktwissen",
    "training.curriculum.module3": "Compliance & Ethik",
    "training.curriculum.module4": "Kommunikationsfähigkeiten",
    "training.cta.title": "Bereit für den Karrierestart?",
    "training.cta.button": "Jetzt Bewerben",

    // Training enhanced sections
    "training.stats.trainees": "Ausgebildete Fachkräfte",
    "training.stats.rate": "Erfolgsquote",
    "training.stats.partners": "Partnerunternehmen",
    "training.stats.years": "Jahre Erfahrung",
    "training.benefits.title": "Warum Unser Programm",
    "training.benefits.mentorship": "Experten-Mentoring",
    "training.benefits.mentorshipDesc": "Lernen Sie von Branchenveteranen mit jahrzehntelanger Erfahrung",
    "training.benefits.practical": "Praktische Ausbildung",
    "training.benefits.practicalDesc": "Reale Szenarien und praktische Übungen",
    "training.benefits.certification": "Zertifizierung",
    "training.benefits.certificationDesc": "Erhalten Sie eine anerkannte Branchenzertifizierung",
    "training.benefits.placement": "Karrierevermittlung",
    "training.benefits.placementDesc": "Direkte Beschäftigungsmöglichkeiten bei unseren Partnern",
    "training.process.title": "Ausbildungsweg",
    "training.process.step1.title": "Bewerbung",
    "training.process.step1.desc": "Reichen Sie Ihre Bewerbung und Unterlagen ein",
    "training.process.step2.title": "Auswahl",
    "training.process.step2.desc": "Vorstellungsgespräch und Bewertungsprozess",
    "training.process.step3.title": "Ausbildung",
    "training.process.step3.desc": "Intensives 3-Monats-Programm",
    "training.process.step4.title": "Vermittlung",
    "training.process.step4.desc": "Treten Sie unserem Team oder Partnern bei",

    // Regulatory Services Page
    "nav.regulatory": "Regulatorische Dienstleistungen",
    "regulatory.hero.badge": "Pharmazeutische Registrierung",
    "regulatory.hero.title": "Arzneimittelregistrierung & Regulatorische Angelegenheiten",
    "regulatory.hero.subtitle": "Ihr vertrauenswürdiger Partner für die Registrierung pharmazeutischer Produkte in Usbekistan. Wir helfen internationalen Unternehmen, sich in der regulatorischen Landschaft zurechtzufinden und ihre Arzneimittel auf den Markt zu bringen.",
    "regulatory.hero.cta": "Beratung Anfordern",

    "regulatory.about.title": "Über Unsere Dienstleistungen",
    "regulatory.about.description": "NEUES LEBEN bietet umfassende regulatorische Dienstleistungen für Pharmaunternehmen, die ihre Produkte in Usbekistan registrieren möchten. Mit jahrelanger Erfahrung und tiefem Verständnis der lokalen Vorschriften gewährleisten wir einen reibungslosen und erfolgreichen Marktzugang für Ihre Arzneimittel.",

    "regulatory.mission.title": "Unsere Mission",
    "regulatory.mission.description": "Schnelle, transparente und zuverlässige regulatorische Lösungen zu liefern und einen reibungslosen und erfolgreichen Marktzugang für Hersteller in Usbekistan zu gewährleisten.",

    "regulatory.categories.pharma": "Pharmazeutika",
    "regulatory.categories.devices": "Medizinprodukte",
    "regulatory.categories.supplements": "Nahrungsergänzungsmittel",

    "regulatory.services.title": "Unsere Kerndienstleistungen",
    "regulatory.services.subtitle": "Umfassende regulatorische Unterstützung für Ihre pharmazeutischen Produkte",

    "regulatory.service1.title": "Registrierung von Arzneimitteln",
    "regulatory.service1.item1": "Vollständige staatliche Registrierung neuer Arzneimittel",
    "regulatory.service1.item2": "Verlängerung und Neuregistrierung",
    "regulatory.service1.item3": "Einreichung von Änderungen zu Registrierungszertifikaten",
    "regulatory.service1.item4": "Vorbereitung von Einreichungspaketen für das Gesundheitsministerium",
    "regulatory.service1.item5": "Vollständiges Management der Kommunikation mit Aufsichtsbehörden",

    "regulatory.service2.title": "Registrierung von Medizinprodukten und Ausrüstung",
    "regulatory.service2.item1": "Registrierung von Medizinprodukten und medizinischer Ausrüstung",
    "regulatory.service2.item2": "Schnellregistrierung durch Anerkennung",
    "regulatory.service2.item3": "Produktklassifizierung und Bewertung des regulatorischen Wegs",
    "regulatory.service2.item4": "Vorbereitung technischer Dokumentation und Kennzeichnung",
    "regulatory.service2.item5": "Nachregistrierungsänderungen und -aktualisierungen",

    "regulatory.service3.title": "Registrierung von Nahrungsergänzungsmitteln, Kosmetika & Sporternährung",
    "regulatory.service3.item1": "Registrierungs- und Benachrichtigungsverfahren",
    "regulatory.service3.item2": "Konformitätsprüfung von Zusammensetzung und Kennzeichnung",
    "regulatory.service3.item3": "Vorbereitung von Sicherheits- und Qualitätsdokumentation",
    "regulatory.service3.item4": "Bearbeitung großer Portfolios in kurzen Zeiträumen",

    "regulatory.service4.title": "Unterstützung bei Klinischen Studien",
    "regulatory.service4.description": "NEUES LEBEN unterstützt Hersteller bei der Organisation und Durchführung klinischer Forschungsaktivitäten in Usbekistan:",
    "regulatory.service4.item1": "Vorbereitung von Einreichungspaketen für klinische Studien",
    "regulatory.service4.item2": "Koordination mit dem Gesundheitsministerium und Ethikkommissionen",
    "regulatory.service4.item3": "Unterstützung bei Protokolllokalisierung und -anpassung",
    "regulatory.service4.item4": "Unterstützung bei Standortauswahl und Kommunikation",
    "regulatory.service4.item5": "Begleitung während des gesamten Genehmigungsprozesses für klinische Studien",

    "regulatory.service5.title": "Vorinspektions- & GMP-Inspektionsunterstützung",
    "regulatory.service5.description": "Wir helfen Herstellern, sich auf nationale GMP-Inspektionen vorzubereiten und diese erfolgreich zu bestehen:",
    "regulatory.service5.item1": "Vorinspektionsaudit basierend auf den GMP-Anforderungen Usbekistans",
    "regulatory.service5.item2": "Lückenanalyse von Herstellungsprozessen und Dokumentation",
    "regulatory.service5.item3": "Vorbereitung von Korrekturmaßnahmenplänen",
    "regulatory.service5.item4": "Unterstützung während Vor-Ort- oder Remote-GMP-Inspektionen",
    "regulatory.service5.item5": "Kommunikation mit nationalen Behörden und Folgedokumentation",

    "regulatory.process.title": "Wie Wir Arbeiten",
    "regulatory.process.step1.title": "Erstberatung",
    "regulatory.process.step1.desc": "Wir analysieren Ihr Produkt und bestimmen den optimalen Registrierungsweg",
    "regulatory.process.step2.title": "Dokumentation",
    "regulatory.process.step2.desc": "Wir erstellen und prüfen alle erforderlichen regulatorischen Dokumente",
    "regulatory.process.step3.title": "Einreichung",
    "regulatory.process.step3.desc": "Wir reichen Ihren Antrag bei den Aufsichtsbehörden ein",
    "regulatory.process.step4.title": "Nachverfolgung",
    "regulatory.process.step4.desc": "Wir verwalten alle Kommunikationen bis zur Genehmigung",

    "regulatory.contact.title": "Beratung Anfordern",
    "regulatory.contact.subtitle": "Bereit, Ihre Produkte in Usbekistan zu registrieren? Kontaktieren Sie unser Regulierungsteam.",
    "regulatory.contact.form.company": "Firmenname",
    "regulatory.contact.form.companyPlaceholder": "Ihr Firmenname",
    "regulatory.contact.form.country": "Land",
    "regulatory.contact.form.countryPlaceholder": "Ihr Land",
    "regulatory.contact.form.productType": "Produkttyp",
    "regulatory.contact.form.productTypePlaceholder": "z.B. Pharmazeutikum, Medizinprodukt, Nahrungsergänzungsmittel",
    "regulatory.contact.form.submit": "Anfrage Senden",

    "regulatory.stats.registrations": "Erfolgreiche Registrierungen",
    "regulatory.stats.countries": "Partnerländer",
    "regulatory.stats.experience": "Jahre Erfahrung",
    "regulatory.stats.clients": "Zufriedene Kunden",

    // News
    "nav.news": "Nachrichten",
    "news.badge": "Unternehmensnachrichten",
    "news.title": "Unternehmensnachrichten & Updates",
    "news.subtitle": "Bleiben Sie über unsere neuesten Veranstaltungen, Partnerschaften, Erfolge und Unternehmensentwicklungen informiert.",
    "news.loading": "Nachrichten werden geladen...",
    "news.tryAgain": "Erneut versuchen",
    "news.searchPlaceholder": "Nachrichten nach Titel suchen...",
    "news.showingArticles": "{count} Artikel angezeigt",
    "news.allCategories": "Alle Kategorien",
    "news.noResults": "Keine Nachrichten gefunden, die Ihren Kriterien entsprechen.",
