...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="w-full py-16 sm:py-20 bg-gray-50 dark:bg-gray-900">
      <div className="container px-4 md:px-6">
        ...
        >
          <div className="space-y-2 max-w-3xl">
            ...
            <p className="text-lg sm:text-xl text-gray-500 dark:text-gray-400">{t("about.subtitle")}</p>
          </div>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center z-20">
              <div className="text-center p-4 sm:p-6 bg-white/90 dark:bg-gray-900/90 rounded-lg shadow-lg max-w-xs sm:max-w-md">
                <h3 className="text-xl sm:text-2xl font-bold text-primary-700 dark:text-primary-300 mb-2">
                  {t("about.founded")}
                </h3>
                <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300">{t("about.warehouse")}</p>
              </div>
            </div>
