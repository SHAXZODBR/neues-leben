...
export default function AboutSection() {
  ...
  return (
    <section
      id="about"
      className="w-full py-16 sm:py-20 bg-muted/50"
    >
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center z-20">
              <div className="text-center p-3 sm:p-5 bg-card/95 rounded-lg shadow-lg w-[90%] max-w-[280px] sm:max-w-md border border-border">
                <h3 className="text-base sm:text-2xl font-bold text-primary mb-1 sm:mb-2 leading-snug">
                  {t("about.founded")}
                </h3>
                <p className="text-xs sm:text-base text-muted-foreground leading-snug">
                  {t("about.warehouse")}
                </p>
              </div>
            </div>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-full h-full bg-gradient-to-br from-primary/10 to-primary/20 opacity-30"></div>
              <div className="absolute w-3/4 h-3/4 border-4 border-primary/30 rounded-xl"></div>
              <div className="absolute w-1/2 h-1/2 border-4 border-primary/20 rounded-xl"></div>
            </div>
          </motion.div>
